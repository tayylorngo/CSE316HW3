            ...
            <WCol size="5">
                {
                    props.auth && <div className="sidebar-options">
                        <WButton className="sidebar-buttons" onClick={props.createNewList} clickAnimation="ripple-light" shape="rounded" color="primary" style={props.listActive}>
                            <i className="material-icons" style={props.listActive}>add</i>
                        </WButton>
